...
interface NavbarProps {
  activeTab: string;
  setActiveTab: (tab: 'home' | 'products' | 'customize') => void;
  cartCount: number;
  onOpenCart: () => void;
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-12">
            ...
            <button onClick={() => setActiveTab('car-silhouettes')} className={`text-[9px] uppercase tracking-[0.3em] font-black transition-all ${activeTab === 'car-silhouettes' ? 'text-white' : 'text-zinc-600 hover:text-white'}`}>Car Silhouettes</button>
          </div>
